            ...
            <section  className="bg-white dark:bg-black dark:text-white px-9 py-14 pr-3  max-w-[calc(100%-58px)]">
                ...
                <div className="text-[15px] dark:text-[#c2c2c2] text-[#494949] leading-[18px] flex flex-col gap-4 ">
                    ...
                    <ul className="list-disc text-[15px]">
                        Після підписання контракту ви отримуєте автомобіль, готовий до будь-яких викликів.
                        ...
                        <li className="ml-4">Податок на розкіш (якщо застосовується) і внески до пенсійного фонду вже сплачені. (Доступно в усіх тарифах)</li>
                        <li className="ml-4">Антигравійний захист (бронеплівка) і тонування вікон. (Доступно в тарифі: Drivovo Subscription)</li>
                        <li className="ml-4">Килимки та базові аксесуари (Доступно в тарифі: Drivovo Subscription)</li>
                    </ul>
