            ...
            {createPortal(
                <div className={ isVisible ? "portalCommunicationModalRight activeModal" : "portalCommunicationModalRight" } ref={ref}>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link href="https://wa.me/15558337564" target="blank" className={cn('w-full bg-[#4EC95C] text-white rounded-[10px] text-sm flex items-center justify-center p-[8px]')}> <Image src="/assets/images/whatsApp.svg" width={24} height={24} alt='WhatsApp' className="mr-2" /> WhatsApp</Link>
