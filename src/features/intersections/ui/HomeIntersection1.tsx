    ...
    return (
        <>
            <div>
                ...
                <button onClick={() => calcRedirect('/catalog')} className="w-full redGradient text-white rounded-[10px] text-sm flex items-center justify-center p-[8px] mt-3" >Замовити лізинг</button>
            </div>
      </>
  )
}
